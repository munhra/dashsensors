...
class HumidityViewController: DataViewController {
    ...
    override func handleData(avg: Int, max: Int, min: Int, dataArray: [Int], timestampArray: [Int], firstDataBeforeStart: Int) {
        ...
        customLineChartView.setData(dataArray: reducedDataArray, timestampArray: reducedTimestampArray, field: "Humidity", timeInterval: timeInterval[timeIntervalIndex], reducedTimeInterval: reducedTimeInterval[timeIntervalIndex])
    }
    ...
    override func viewDidLoad() {
        ...
        setupIntervalLabels()
        setupDataLabels()
        customLineChartView.themeColor = UIColor(red: 88/255, green: 86/255, blue: 214/255, alpha: 1.0)
