...
//        }
        customLineChartView.setData(dataArray: reducedDataArray, timestampArray: reducedTimestampArray, field: "Humidity", timeInterval: timeInterval[timeIntervalIndex])
    }
